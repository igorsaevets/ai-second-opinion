...
| an update made a channel stop running | you edited `channels.json` in place, and the folder was replaced | `doctor.py` reports this against a shipped fingerprint. `python upgrade.py --migrate` moves such edits out of the folder for good |
